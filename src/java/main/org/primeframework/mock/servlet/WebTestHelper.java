...
/**
 * This class is a test helper for web testing.
 *
...
public class WebTestHelper {
  ...
  /**
   * Constructs a mock servlet context and determines if project that is using this class is a webapp or a module
   * based on if the {@code web} or {@code src/web/test} directory exists (respectively). If neither directory exists,
   * the context will not be able to resolve the real path and lookup resources.
   *
